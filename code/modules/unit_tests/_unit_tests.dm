...
#include "~nova\custom_sprites\persistence.dm"
...
#include "~nova\custom_sprites\tall_hair.dm"
#include "~nova\custom_sprites\taur_paint.dm"
#include "~nova\custom_sprites\transfer.dm"
