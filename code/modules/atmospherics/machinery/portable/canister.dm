...
/obj/machinery/portable_atmospherics/canister/fusion_test/create_gas()
	...
	air_contents.set_temperature(10000) // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: air_contents.temperature = 10000
...
/obj/machinery/portable_atmospherics/canister/proc/create_gas()
	if(!gas_type)
		return
	air_contents.adjust_gas(gas_type, (maximum_pressure * filled) * air_contents.return_volume() / (R_IDEAL_GAS_EQUATION * air_contents.return_temperature())) // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: air_contents.adjust_gas(gas_type, (maximum_pressure * filled) * air_contents.volume / (R_IDEAL_GAS_EQUATION * air_contents.temperature))
	SSair.start_processing_machine(src)
