...
/obj/machinery/atmospherics/components/binary/temperature_pump/process_atmos()
	...
	var/coolant_temperature_delta = remove_input.return_temperature() - remove_output.return_temperature() // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: var/coolant_temperature_delta = remove_input.temperature - remove_output.temperature
