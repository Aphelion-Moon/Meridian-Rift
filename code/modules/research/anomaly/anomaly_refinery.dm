...
/obj/machinery/research/anomaly_refinery/proc/simulate_valve()
	...
	if(reaction_increment == 0)
		...
		combined_gasmix.set_volume(first_gasmix.return_volume() + second_gasmix.return_volume()) // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: combined_gasmix.volume = first_gasmix.volume + second_gasmix.volume
