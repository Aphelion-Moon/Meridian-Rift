...
/obj/machinery/computer/turbine_computer/ui_data(mob/user)
	...
	.["temp"] = main_control.compressor.input_turf?.air.return_temperature() || 0 // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: .["temp"] = main_control.compressor.input_turf?.air.temperature || 0
