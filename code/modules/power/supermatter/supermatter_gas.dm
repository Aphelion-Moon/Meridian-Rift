...
/datum/sm_gas/carbon_dioxide/extra_effects(obj/machinery/power/supermatter_crystal/sm)
	...
	var/consumed_co2 = sm.absorbed_gasmix.get_moles(/datum/gas/carbon_dioxide) * co2_ratio // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: var/consumed_co2 = sm.absorbed_gasmix.moles[/datum/gas/carbon_dioxide] * co2_ratio
	consumed_co2 = min(
		consumed_co2,
...
/datum/sm_gas/miasma/extra_effects(obj/machinery/power/supermatter_crystal/sm)
	...
	var/consumed_miasma = sm.absorbed_gasmix.get_moles(/datum/gas/miasma) * miasma_ratio // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: var/consumed_miasma = sm.absorbed_gasmix.moles[/datum/gas/miasma] * miasma_ratio
	if(!consumed_miasma)
		return
