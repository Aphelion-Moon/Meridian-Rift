...
/obj/effect/holodeck_effect/sparks/activate(obj/machinery/computer/holodeck/HC)
	...
	if(T)
		do_sparks(3, TRUE, T)
		T.set_temperature(5000) //Why? not quite sure to be honest with you // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: T.temperature = 5000 //Why? not quite sure to be honest with you
