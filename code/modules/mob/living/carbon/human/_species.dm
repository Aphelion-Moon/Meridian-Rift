...
/datum/species/proc/handle_gas_interaction(mob/living/carbon/human/human, datum/gas_mixture/environment, seconds_per_tick)
	...
	var/antinoblium_moles = environment.get_moles(/datum/gas/antinoblium) // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: var/antinoblium_moles = environment.moles[/datum/gas/antinoblium]
