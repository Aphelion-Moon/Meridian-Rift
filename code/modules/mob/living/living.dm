...
/mob/living/proc/get_temperature(datum/gas_mixture/environment)
	var/loc_temp = environment ? environment.return_temperature() : T0C // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: var/loc_temp = environment ? environment.temperature : T0C
	if(isobj(loc))
		var/obj/oloc = loc
		...
		loc_temp = heat_turf.GetTemperature() // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: loc_temp = heat_turf.temperature
	if(ismovable(loc))
