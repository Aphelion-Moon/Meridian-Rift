...
/obj/item/organ/lungs/proc/on_low_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp) // NOVA EDIT CHANGE - (maybe upstream this?) - ORIGINAL: /obj/item/organ/lungs/fish/proc/on_low_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp)
	...
	var/gas_breathed = handle_suffocation(breather, water_pp, safe_water_level, breath.get_moles(/datum/gas/water_vapor)) // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: var/gas_breathed = handle_suffocation(breather, water_pp, safe_water_level, breath.moles[/datum/gas/water_vapor])
	if(water_pp)
