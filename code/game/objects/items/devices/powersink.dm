...
/obj/item/powersink/proc/release_heat()
	...
	if(delta_temperature)
		environment.set_temperature(environment.return_temperature() + delta_temperature) // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: environment.temperature += delta_temperature
