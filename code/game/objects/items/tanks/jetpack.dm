...
/obj/item/tank/jetpack/populate_gas()
	if(gas_type)
		...
		our_mix.set_moles(gas_type,  ((6 * ONE_ATMOSPHERE) * volume / (R_IDEAL_GAS_EQUATION * T20C))) // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: our_mix.set_gas(gas_type,  ((6 * ONE_ATMOSPHERE) * volume / (R_IDEAL_GAS_EQUATION * T20C)))
