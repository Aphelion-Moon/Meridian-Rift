...
/proc/get_perceived_radiation_danger(datum/radiation_pulse_information/pulse_information, insulation_to_target)
	if (insulation_to_target > pulse_information.threshold)
		...
		if (insulation_to_target <= pulse_information.threshold * MEDIUM_RADIATION_THRESHOLD_RANGE) // APHELION EDIT CHANGE - DOGMOS_PLAYTEST_REGRESSIONS - ORIGINAL: if (insulation_to_target / pulse_information.threshold <= MEDIUM_RADIATION_THRESHOLD_RANGE)
