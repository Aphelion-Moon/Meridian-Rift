...
/datum/component/grillable/proc/on_location_changed(atom/source)
	...
	on_turf_atmos_changed(current_turf, current_turf.air, current_turf.air?.return_temperature() || 0) // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: on_turf_atmos_changed(current_turf, current_turf.air, current_turf.air?.temperature || 0)
