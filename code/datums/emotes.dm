...
/datum/emote/proc/run_emote(mob/user, params, type_override, intentional = FALSE)
	...
	if(running_emote_type & EMOTE_RUNECHAT)
		...
		// AI-eye emotes
		if(is_visual)
			relay_visual_emote_to_ai_runechat(user, msg, pref_to_check) // APHELION EDIT CHANGE - Pref checked emotes - ORIGINAL: relay_visual_emote_to_ai_runechat(user, msg)
...
/proc/relay_visual_emote_to_ai_runechat(mob/user, msg, pref_to_check) // APHELION EDIT CHANGE - Pref checked emotes - ORIGINAL: /proc/relay_visual_emote_to_ai_runechat(mob/user, msg)
	...
	for(var/mob/living/silicon/ai/AI as anything in GLOB.ai_list)
		if(!AI?.client)
			continue
		// APHELION EDIT ADDITION START - Pref checked emotes
