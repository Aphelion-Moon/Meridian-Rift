...
/obj/item/clothing/under/rank/bridge_officer/skirt
	...
	supports_variations_flags = CLOTHING_DIGITIGRADE_VARIATION_NO_NEW_ICON
	gets_cropped_on_taurs = FALSE
	worn_icon_vox = 'modular_nova/master_files/icons/mob/clothing/under/command.dmi'
...
/obj/item/clothing/under/imperialskirt
	...
	flags_1 = IS_PLAYER_COLORABLE_1
	can_adjust = FALSE
	greyscale_config_worn_vox = /datum/greyscale_config/officersnavalskirt/worn
...
/obj/item/clothing/under/imperialskirtvest
	...
	armor_type = /datum/armor/clothing_under/security_head_of_security
	can_adjust = FALSE
	greyscale_config_worn_vox = /datum/greyscale_config/officersnavalskirtvest/worn
