...
/datum/supply_pack/companies/generate(atom/A, datum/bank_account/paying_account, crate_override)
	...
	cargo_dep.adjust_money(round(cost * CARGO_CUT), "Cargo: Company purchase commission") // NOVA EDIT CHANGE - PERSISTENT_ECONOMY - ORIGINAL: cargo_dep.account_balance += round(cost * CARGO_CUT)
