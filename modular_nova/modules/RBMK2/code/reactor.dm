...
/obj/machinery/power/rbmk2/ui_data(mob/user)
	...
	data["rod_trit_moles"] = stored_rod?.air_contents.get_moles(/datum/gas/tritium) || 0 // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: data["rod_trit_moles"] = stored_rod?.air_contents.moles[/datum/gas/tritium] || 0
	// rod temperature
	data["rod_mix_temperature"] = stored_rod?.air_contents.return_temperature() || 0 // APHELION EDIT CHANGE - DOGMOS - ORIGINAL: data["rod_mix_temperature"] = stored_rod?.air_contents.temperature || 0
