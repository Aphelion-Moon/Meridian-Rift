 ...
 *
 * Arguments:
 * * remove_uninitialized - Whether a newly replaced non-atmos turf must invalidate the previous native registration.
 */
...
/** Returns this turf's native heat temperature. */
