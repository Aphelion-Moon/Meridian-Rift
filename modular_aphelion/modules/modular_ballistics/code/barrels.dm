...
/obj/item/ballistic_module/barrel
	...
	/// Base interval between discharges, before receiver and accessory costs.
	var/shot_delay = 0.25 SECONDS
	/// Multiplies each shaving's base damage.
