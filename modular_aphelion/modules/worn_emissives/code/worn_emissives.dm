...
/**
 * Prepares the final bodypart slot, where direct glow/blocker masks already have their centering and
 ...
 *
 * Arguments:
 * * bodypart_overlays - the BODYPARTS_LAYER cache entry, a list or a single appearance
 *
