...
| Fast compiler gate | `RIFT.cmd compile --mode fast --profile ci` (uses `-DCBT`) | DreamMaker acceptance only |
...
| Rust/Dogmos | Exact toolchain, targets, tests, bindings, artifacts, DM integration | In-process i686 targets and DM must pass |
